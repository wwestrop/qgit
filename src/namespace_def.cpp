...
const QString QGit::DEF_CLONE_DIR   = "default_clone_directory";
...
void QGit::initMimePix() {
	...
	QPixmap* pm = new QPixmap(QString::fromUtf8(":/icons/resources/folder.svg"));
	...
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-dockerfile.svg"));
	mimePixMap.insert("Dockerfile", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-csv.svg"));
	mimePixMap.insert("csv", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-csrc.svg"));
	mimePixMap.insert("c", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-c++src.svg"));
	mimePixMap.insert("cpp", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-chdr.svg"));
	mimePixMap.insert("h", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-c++hdr.svg"));
	mimePixMap.insert("hpp", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-generic.svg"));
	mimePixMap.insert("txt", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-rtf.svg"));
	mimePixMap.insert("rtf", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-script.svg"));
	mimePixMap.insert("sh", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-perl.svg"));
	mimePixMap.insert("perl", pm);
	pm = new QPixmap(*pm);
	mimePixMap.insert("pl", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-python-bytecode.svg"));
	mimePixMap.insert("py", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-java.svg"));
	mimePixMap.insert("java", pm);
	pm = new QPixmap(*pm);
	mimePixMap.insert("jar", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-tar.svg"));
	mimePixMap.insert("tar", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-ace.svg"));
	mimePixMap.insert("gz", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-compressed-tar.svg"));
	mimePixMap.insert("tgz", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-zip.svg"));
	mimePixMap.insert("zip", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-bzip.svg"));
	mimePixMap.insert("bz", pm);
	pm = new QPixmap(*pm);
	mimePixMap.insert("bz2", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-html.svg"));
	mimePixMap.insert("html", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/dialog-xml-editor.svg"));
	mimePixMap.insert("xml", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-bmp.svg"));
	mimePixMap.insert("bmp", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-gif.svg"));
	mimePixMap.insert("gif", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-jpeg.svg"));
	mimePixMap.insert("jpg", pm);
	pm = new QPixmap(*pm);
	mimePixMap.insert("jpeg", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-png.svg"));
	mimePixMap.insert("png", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-svg+xml-compressed.svg"));
	mimePixMap.insert("svg", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-tiff.svg"));
	mimePixMap.insert("tiff", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-x-ico.svg"));
	mimePixMap.insert("ico", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-x-xcf.svg"));
	mimePixMap.insert("xcf", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/image-x-generic.svg"));
	...
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-json.svg"));
	mimePixMap.insert("json", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-pdf.svg"));
	mimePixMap.insert("pdf", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-javascript.svg"));
	mimePixMap.insert("js", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-go.svg"));
	mimePixMap.insert("go", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-markdown.svg"));
	mimePixMap.insert("md", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-patch.svg"));
	mimePixMap.insert("patch", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-qml.svg"));
	mimePixMap.insert("qml", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-tex.svg"));
	mimePixMap.insert("tex", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-ruby.svg"));
	mimePixMap.insert("rb", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-rust.svg"));
	mimePixMap.insert("rs", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-css.svg"));
	mimePixMap.insert("css", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-csharp.svg"));
	mimePixMap.insert("cs", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/text-x-r.svg"));
	mimePixMap.insert("r", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-designer.svg"));
	mimePixMap.insert("ui", pm);
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/project-development.svg"));
	...
	pm = new QPixmap(QString::fromUtf8(":/icons/resources/file/application-x-sharedlib.svg"));
